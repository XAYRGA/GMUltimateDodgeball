...
for k,v in pairs (file.Find("dodgeball/gamemode/server/*.lua","LUA")) do
	MsgN("[D.O.D.G.E]: Loaded server file: " .. v)
	include("dodgeball/gamemode/server/" .. v); 
end
print("===SENDING CLIENTSIDE FILES===")
for k,v in pairs (file.Find("dodgeball/gamemode/shared/*.lua","LUA")) do
	MsgN("--->" .. v)
	AddCSLuaFile("dodgeball/gamemode/shared/" .. v); 
end
for k,v in pairs (file.Find("dodgeball/gamemode/client/*.lua","LUA")) do
	MsgN("--->" .. v)
	AddCSLuaFile("dodgeball/gamemode/client/" .. v); 
end
print("===DONE===")
