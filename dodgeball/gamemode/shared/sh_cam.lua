...
CreateClientConVar("chasecam_back", 150, true, false)
CreateClientConVar("chasecam_right", 0, true, false)
CreateClientConVar("chasecam_up", 20, true, false)
...
hook.Add("PlayerSpawn","nope",function(pl)
		ThirdPerson.Enable(pl)

	end)
hook.Add("PlayerDeath","nope",function(pl)
		ThirdPerson.Disable(pl)
